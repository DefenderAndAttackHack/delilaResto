...
router.get("/", validate_token, async (req, res, next) => {
	try {
		// Obtiene una lista de todos los pedidos solo si es administrador; de lo contrario, solo obtiene resultados que coinciden con la ID del usuario
		let orders = [];
		...
		// Agrega los detalles de la lista de productos a cada pedido.
